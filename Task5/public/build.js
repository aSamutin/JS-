...
/***/ function(module, exports, __webpack_require__) {
	...
	var User = __webpack_require__(8).User;
	var roles = __webpack_require__(8).roles;
	var statuses = __webpack_require__(8).statuses;
	var priorities = __webpack_require__(8).priorities;
	var usersList = __webpack_require__(8).usersList;
	var Comment = __webpack_require__(8).Comment;
	var Ticket = __webpack_require__(8).Ticket;
	var saveObject = __webpack_require__(8).saveObject;
	var saveUser = __webpack_require__(8).saveUser;
	var getObject = __webpack_require__(8).getObject;
	var Admin = __webpack_require__(8).Admin;

	var getUser = __webpack_require__(8).getUser;
	var getTickets = __webpack_require__(8).getTickets;
	var getUserList = __webpack_require__(8).getUserList;
...
/***/ function(module, exports) {
	...
	'\n                    </td>\n                    <td>\n                        ' +
	((__t = (list[i].clientId)) == null ? '' : __t) +
	'\n                    </td>\n                    <td>\n                        ' +
	((__t = (list[i].executorId)) == null ? '' : __t) +
	'\n                    </td>\n                    <td>\n                        ' +
	((__t = (list[i].description)) == null ? '' : __t) +
	'\n                    </td>\n                    <td>\n                        ' +
	((__t = (list[i].priority)) == null ? '' : __t) +
	'\n                    </td>\n                    <td>\n                        ' +
	((__t = (list[i].estimated)) == null ? '' : __t) +
	'\n                    </td>\n                    <td>\n                        ' +
	((__t = (list[i].deadline)) == null ? '' : __t) +
	'\n                    </td>\n                    <td>\n                        ' +
	((__t = (list[i].percentReady)) == null ? '' : __t) +
	'\n                    </td>\n                    <td>\n                        ' +
	((__t = (list[i].status)) == null ? '' : __t) +
	'\n                    </td>\n                </tr>\n            ';
	 }; ;
	__p += '\n          ';
	 } else { ;
	__p += '\n            <tr><td colspan="9" align="center">Нет заявок</td></tr>\n          ';
	 }; ;
	__p += '\n        </tbody>\n      </table>\n</div>\n';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comment = __webpack_require__(8).Comment;
	var Ticket = __webpack_require__(8).Ticket;
	var hTable = __webpack_require__(8).hTable;
	var saveObject = __webpack_require__(8).saveObject;
	var saveUser = __webpack_require__(8).saveUser;
	var getObject = __webpack_require__(8).getObject;
	var Admin = __webpack_require__(8).Admin;
	...
	var getUserList = __webpack_require__(8).getUserList;
	var getTickets = __webpack_require__(8).getTickets;
	var getTicket = __webpack_require__(8).getTicket;
	var getComments = __webpack_require__(8).getComments;

	$(document).ready(function(){
	  $('div').on('click','#openCreateTicket', function () {
	    var usersList = getUserList(); //Массив пользователей 
	    var clientList = _.map(_.filter(usersList, {'role':'Client'}), 'login');
	    tmpl = __webpack_require__(15); 
